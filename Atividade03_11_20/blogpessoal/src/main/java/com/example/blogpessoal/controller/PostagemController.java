...
public class PostagemController {
	...
	/*@PostMapping
	public ResponseEntity<Postagem> Postagem (@RequestBody Postagem postagem){
...
/*Insert Into  blog_pessoal.postagem(data, texto, titulo)  values ("2020-04-10 10:10:10","Estou aprendendo","Api Rest Spring"); */
